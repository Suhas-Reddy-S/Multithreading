...
void main(void)
{
    ...
    printf("Starting Sequencer Demo RTES Exercise 5 Q1 seqgen.c\n\n");
   ...
   printf("\nSequencer: \nTime Period: %lf msec, Deadline: %lf msec", (double)1000/30, (double)1000/30);      
   printf("\nFrame Sampler: \nTime Period: %lf msec, Deadline: %lf msec", (double)1000/3, (double)1000/3);
   printf("\nTime-stamp with Image Analysis: \nTime Period: %lf msec, Deadline: %lf msec", (double)1000/1, (double)1000/1);
   printf("\nDifference Image Proc: \nTime Period: %lf msec, Deadline: %lf msec", (double)2*1000/1, (double)2*1000/1);
   printf("\nTime-stamp Image Save to File: \nTime Period: %lf msec, Deadline: %lf msec", (double)1000/1, (double)1000/1);
   printf("\nProcessed Image Save to File: \nTime Period: %lf msec, Deadline: %lf msec", (double)2*1000/1, (double)2*1000/1);
   printf("\nSend Time-stamped Image to Remote: \nTime Period: %lf msec, Deadline: %lf msec", (double)1000/1, (double)1000/1);
   printf("\n10 Sec Tick Debug: \nTime Period: %lf msec, Deadline: %lf msec\n\n", (double)10*1000/1, (double)10*1000/1);
   ...
   printf("\nWCET for 7 services\n");
   printf("\nFrame Sampler WCET: %lu msec", wcet[0]);
   printf("\nTime-stamp with Image Analysis WCET: %lu msec", wcet[1]);
   printf("\nDifference Image Proc WCET: %lu msec", wcet[2]);
   printf("\nTime-stamp Image Save to File WCET: %lu msec", wcet[3]);
   printf("\nProcessed Image Save to File WCET: %lu msec", wcet[4]);
   printf("\nSend Time-stamped Image to Remote WCET: %lu msec", wcet[5]);
   printf("\n10 Sec Tick Debug WCET: %lu msec\n", wcet[6]);
...
void *Service_1(void *threadp)
{
    ...
    while(!abortS1)
    {
        ...
        exec_time = (long)end_time.tv_nsec/1000000 - (long)start_time.tv_nsec/1000000;
